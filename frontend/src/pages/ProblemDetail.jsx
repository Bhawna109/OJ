        ...
        <div className="h-56 border-t border-gray-200 bg-white flex flex-col">
          <div className="flex items-center gap-4 px-4 pt-3 border-b border-gray-100">
            <button onClick={() => setActiveTab('input')}
              className={`text-sm pb-2 font-medium border-b-2 transition-colors ${activeTab === 'input' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500'}`}>
              Input
            </button>
            <button onClick={() => setActiveTab('output')}
              className={`text-sm pb-2 font-medium border-b-2 transition-colors ${activeTab === 'output' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500'}`}>
              Output
            </button>
            <button onClick={() => setActiveTab('ai')}
              className={`text-sm pb-2 font-medium border-b-2 transition-colors ${activeTab === 'ai' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500'}`}>
              AI Review
            </button>
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button onClick={handleSubmit} disabled={isSubmitting}
                className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white text-sm font-medium px-4 py-1.5 rounded-lg transition-colors">
